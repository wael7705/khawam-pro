"""
سكريبت لإصلاح قاعدة البيانات يعمل على Railway مباشرة
يستخدم DATABASE_URL من Railway تلقائياً
"""
import sys
import os
...
# الحصول على DATABASE_URL من Railway (يتم توفيره تلقائياً)
DATABASE_URL = os.getenv("DATABASE_URL")

if not DATABASE_URL:
    print("❌ خطأ: DATABASE_URL غير موجود!")
    print("هذا السكريبت يجب تشغيله على Railway")
    sys.exit(1)
...
print("=" * 70)
print("🔥 سكريبت إصلاح قاعدة البيانات - Railway")
print("=" * 70)
...
try:
    ...
    try:
        ...
        print("=" * 70)
        print("\n✅ المستخدمون الجدد جاهزون لتسجيل الدخول!")
        print("\n")
